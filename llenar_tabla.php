...
$arr = [
    [
        ...
        "imatge" => "vista/img/DSC_7423ret2baixa1.jpg"
    ],
    ...
    [
        ...
        "imatge" => "vista/img/tete-concierto-210217.original.jpg"
    ],
    ...
    [
        ...
        "imatge" => "vista/img/240303_logo_Foto_horizontal_para_Ticketea_claim.jpg"
    ],

    [
        "titol" => "Carlos Vives",
        "subtitol" => "",
        "imatge" => "vista/img/258729_logo_Carlos_Vives_ticketea_claim.jpg"
    ],

    [
        "titol" => "IZARO",
        "subtitol" => "",
        "imatge" => "vista/img/257415_logo_izaro_claim.jpg"
    ],

    [
        "titol" => "THE VERY BEST OF DIRE STRAITS",
        "subtitol" => "bROTHES iN bAND. dIRE sTRAITS. The Very Best of dIRE sTRAITS SHOW",
        "imatge" => "vista/img/051214124520_theverybestinternet.jpeg"
    ]
];
...
$arr = [
    [
        "lloc" => "SALA BIKINI",
        "adreca" => "L'illa Diagonal, L'Illia, Avinguda Diagonal, 547",
        "localitat" => "08029 Barcelona"
    ],
    [
        "lloc" => "EL MOLINO",
        "adreca" => "Carrer de Vila i Vilà, 99",
        "localitat" => "08004 Barcelona"
    ],
    [
        "lloc" => "SALA APOLO 2",
        "adreca" => "Carrer Nou de la Rambla, 111",
        "localitat" => "08004 Barcelona"
    ],
    [
        "lloc" => "Sala Rocksound",
        "adreca" => "Carrer dels Almogàvers, 116",
        "localitat" => "08018 Barcelona"
    ],
    [
        "lloc" => "Continental Bar",
        "adreca" => "Carrer de la Providència, 32",
        "localitat" => "08024 Barcelona"
    ],
    [
        "lloc" => "Sant Jordi Club",
        "adreca" => "Passeig Olímpic, 5",
        "localitat" => "08038 Barcelona"
    ],
    [
        "lloc" => "SALA BARTS",
        "adreca" => "Av. del Paraŀlel, 62",
        "localitat" => "08001 Barcelona"
    ],
    [
        "lloc" => "Razzmatazz",
        "adreca" => "Carrer de Pamplona, 88",
        "localitat" => "08018 Barcelona"
    ],
    [
        "lloc" => "Sala Jamboree ",
        "adreca" => "Plaça Reial, 17",
        "localitat" => "08002 Barcelona"
    ],
    [
        "lloc" => "Sala Bóveda",
        "adreca" => "Carrer de Roc Boronat, 33",
        "localitat" => "08005 Barcelona"
    ],
    [
        "lloc" => "Palau de la Música Catalana",
        "adreca" => "Carrer del Palau de la Música, 4",
        "localitat" => "08003 Barcelona"
    ]
];
...
$arr = [
    [
        "id" => "24831VDKRB95CR",
        "event" => "THE VERY BEST OF DIRE STRAITS",
        "loc" => "SALA BARTS",
        "zona" => "PLATEA",
        "fila" => 1,
        "butaca" => 18,
...
foreach ($arr as $ar) {
    $event = new Entrada();
    $event->setId($ar["id"]);
    $ev = $repoEvent->findOneBy(array(
        'titol' => $ar["event"]
    ));
    $event->setEvent($ev);
    $event->setData($repoData->findOneBy(array(
        'id' => (($i % 18) + 1)
    )));
    $event->setLocalitzacio($repoLoc->findOneBy(array(
        "lloc" => $ar["loc"]
    )));
    if (is_null($ar["zona"])) {
        $event->setZona($repoZona->findOneById(($i % 6) + 1));
    } else {
        $event->setZona($repoZona->findOneBy(array(
            "descripcio" => $ar['zona']
        )));
    }
